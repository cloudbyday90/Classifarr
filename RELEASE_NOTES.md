...
- Every policy screen has a production-preview smoke that verifies its lazy page chunk and a fixed cold-load asset budget without contacting an application API; protected CI runs it with Chromium.
