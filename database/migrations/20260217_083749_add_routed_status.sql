...
-- Migration: 20260217_083749_add_routed_status.sql
-- Purpose: Add 'routed' status to classification_history for items successfully routed to *arr
...
ADD CONSTRAINT classification_history_status_check CHECK (
    status IN (
        ...
        'routed'             -- Item was successfully routed to *arr after resolution
    )
);
