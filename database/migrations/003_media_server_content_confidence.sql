...
INSERT INTO confidence_thresholds (tier, min_confidence, max_confidence, action, description) VALUES
('auto', 90, 100, 'auto_route', 'Automatically route without interaction'),
('verify', 70, 89, 'verify_buttons', 'Show Yes/No verification buttons'),
('clarify', 50, 69, 'clarify_questions', 'Ask clarifying questions'),
('manual', 0, 49, 'manual_selection', 'Request manual library selection')
...
ALTER TABLE classification_history ADD COLUMN IF NOT EXISTS clarification_status VARCHAR(20);
...
INSERT INTO clarification_questions (question_text, question_type, trigger_keywords, trigger_genres, response_options, priority, enabled) VALUES
(
    'Is this a stand-up comedy special?',
    'content_type',
    ARRAY['stand-up', 'comedy special', 'standup', 'live comedy'],
    ARRAY['Documentary', 'Comedy'],
    '{"yes": {"label": "Stand-Up Special", "confidence_boost": 30}, "no": {"label": "Regular Content", "confidence_boost": -10}}',
    10,
    true
),
(
    ...
    '{"yes": {"label": "Concert Film", "confidence_boost": 30}, "no": {"label": "Regular Content", "confidence_boost": -10}}',
    9,
    true
),
(
    ...
    '{"yes": {"label": "Adult Animation", "confidence_boost": 30}, "no": {"label": "Family Animation", "confidence_boost": -10}}',
    8,
    true
),
(
    ...
    '{"yes": {"label": "Reality Competition", "confidence_boost": 30}, "no": {"label": "Regular Show", "confidence_boost": -10}}',
    7,
    true
),
(
    ...
    ARRAY[],
    ARRAY[],
    '{"english": {"label": "English", "confidence_boost": 40}, "japanese": {"label": "Japanese", "confidence_boost": 40}, "korean": {"label": "Korean", "confidence_boost": 40}, "other": {"label": "Other Language", "confidence_boost": 0}}',
    5,
    true
)
