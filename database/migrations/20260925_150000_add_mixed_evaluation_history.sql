...
-- Preserve prior evaluation evidence; v3 records bounded pair-origin categories.
...
ALTER TABLE automatic_evaluation_history
    ADD CONSTRAINT automatic_evaluation_history_result_check CHECK (COALESCE((
        ...
        AND result->>'version' IN ('evaluation_history.v1', 'evaluation_history.v2', 'evaluation_history.v3')
