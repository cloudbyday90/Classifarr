...
-- RUN MIGRATIONS
-- ===========================================
\ir migrations/001_add_arr_settings.sql
\ir migrations/002_add_arr_connection_fields.sql
\ir migrations/003_media_server_content_confidence.sql
\ir migrations/004_enhanced_logging.sql
\ir migrations/005_add_require_all_confirmations_setting.sql
\ir migrations/006_add_clarification_settings.sql
\ir migrations/007_add_clarification_response.sql
\ir migrations/008_add_task_queue.sql
\ir migrations/009_add_multi_manager.sql
\ir migrations/010_add_scheduled_tasks.sql
\ir migrations/011_remove_email_column.sql
\ir migrations/011_add_library_rules.sql
\ir migrations/012_add_library_custom_rules.sql
\ir migrations/013_unify_library_rules.sql
\ir migrations/014_add_classification_methods.sql
