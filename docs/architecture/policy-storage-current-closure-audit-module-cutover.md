...
- OWASP Logging Cheat Sheet recommends consistent event attributes and avoiding
  ambiguous records. The audit now emits `policy.storage_current_closure_audit.v1`
...
- Replaced the payload version with `policy.storage_current_closure_audit.v1`.
