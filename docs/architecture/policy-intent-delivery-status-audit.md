...
| 4R | Active | Source inventory and validated server workflow presentation boundary are complete | Complete live 4R.1 verification, then 4R.3 through 4R.9 in dependency order |
...
5. **4R.3** next binds every interactive action to a truthful outcome.
