        ...
        <table class="w-full">
          <thead class="border-b border-gray-700">
            <tr class="text-left text-sm text-gray-400">
              ...
              <th class="p-3">Classifarr Path</th>
    ...
    <div v-if="showFolderBrowser" class="fixed inset-0 bg-black/50 flex items-center justify-center z-[60]" @click.self="closeFolderBrowser">
      <div class="bg-gray-800 rounded-lg border border-gray-700 max-w-lg w-full mx-4 max-h-[80vh] flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto p-4">
          <div v-if="browserLoading" class="text-center py-8 text-gray-400">Loading...</div>
          <div v-else-if="browserFolders.length === 0" class="text-center py-8 text-gray-500">No subdirectories found</div>
        ...
        <div class="p-4 border-t border-gray-700 flex gap-3">
          <button @click="selectFolder" class="flex-1 px-4 py-2 bg-green-600 hover:bg-green-700 rounded-lg font-medium">Select This Folder</button>
          <button @click="closeFolderBrowser" class="flex-1 px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg font-medium">Cancel</button>
        </div>
      </div>
    </div>
  </div>
