            ...
            <div>
              ...
              >
                <option value="include">
                  Include (allow these ratings)
                </option>
                <option value="exclude">
                  Exclude (block these ratings)
                </option>
                <option value="max">
            ...
            <div v-if="form.signals.certifications.mode === 'include'">
              ...
              <div class="flex flex-wrap gap-2">
                <label
                  ...
                  :key="rating"
                  class="flex items-center gap-2 px-3 py-2 bg-background-light rounded-sm border border-gray-700 text-sm"
                >
                  <input
