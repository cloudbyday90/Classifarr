  ...
  <Card class="hover:border-primary transition-colors">
    <div class="space-y-4">
      ...
      <div class="flex items-center gap-3 pb-3 border-b border-gray-800">
        ...
        <div class="flex-1">
          <h4 class="text-sm font-medium text-gray-400">{{ policy.library_name || 'Library' }}</h4>
        </div>
      </div>
      ...
      <div class="flex items-start justify-between">
        <div class="flex-1">
          <div class="flex items-center gap-3 mb-1">
            ...
            <Badge v-if="policy.preset_count > 0" variant="info">{{ policy.preset_count }} presets</Badge>
          </div>
