      ...
      <div class="bg-gray-800 rounded-lg shadow-xl p-8">
        ...
        >
          ...
          <p class="text-gray-400 mb-4">
            Required for metadata enrichment
          </p>
          ...
          <div
            v-if="stepStatus"
            :class="['p-3 rounded-lg', stepStatus.type === 'success' ? 'bg-green-900/30 text-green-400' : 'bg-red-900/30 text-red-400']"
          >
            {{ stepStatus.message }}
          </div>
        ...
        >
          ...
          <p class="text-gray-400 mb-4">
            Configure AI classification engine
          </p>
        ...
        >
          ...
          <p class="text-gray-400 mb-4">
            Configure Discord bot for notifications
          </p>
