...
<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-gray-400 text-sm">
          Configure your Radarr movie manager connections
        </p>
      </div>
      ...
      >
        <div class="flex justify-between items-center">
          <h3 class="text-lg font-medium">
            Editing: {{ instance.name || `Radarr ${index + 1}` }}
          </h3>
          <button 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              v-model="editForm.minimum_availability"
              class="w-full px-4 py-2 bg-gray-900 border border-gray-600 rounded-lg"
            >
    ...
    >
      <div class="flex justify-between items-center">
        <h3 class="text-lg font-medium">
          {{ configs.length === 0 ? 'Configure Radarr' : 'Add New Radarr Instance' }}
        </h3>
        <button 
