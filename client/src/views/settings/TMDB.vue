  ...
  <div class="space-y-6">
    <div>
      ...
      <p class="text-gray-400 text-sm">
        Configure TMDB API for metadata enrichment
      </p>
    </div>
    ...
    >
      ...
      <div
        v-if="connectionStatus.status === 'error' && isEditing"
        class="p-3 rounded-lg bg-red-900/30 text-red-400 border border-red-900/50"
      >
        {{ connectionStatus.error }}
      </div>
      <div
        v-if="connectionStatus.status === 'success' && isEditing"
        class="p-3 rounded-lg bg-green-900/30 text-green-400 border border-green-900/50"
      >
