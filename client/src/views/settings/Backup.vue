...
<template>
  <div class="space-y-6">
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-lg p-6">
      ...
      <div class="space-y-4">
        ...
        >
          ...
          <p
            v-if="exportPassword && exportPassword !== exportPasswordConfirm"
        ...
        <!-- Plaintext Warning -->
        <div
          v-if="exportType === 'plaintext'"
          class="bg-yellow-900/30 border border-yellow-700 rounded-lg p-4"
        >
      ...
      <div class="space-y-4">
        ...
        >
          ...
          <div class="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
            ...
            <div class="text-blue-400">
              {{ preview.itemCounts.mediaServers }}
            </div>
            ...
            <div class="text-green-400">
              {{ preview.itemCounts.customRules }}
            </div>
            ...
            <div class="text-purple-400">
              {{ preview.itemCounts.learningPatterns }}
            </div>
            ...
            <div class="text-yellow-400">
              {{ preview.itemCounts.autoLearnedPreferences }}
            </div>
          </div>
        </div>
        ...
        <div v-if="preview">
          ...
          >
            <option value="replace">
              Replace (Clear existing configuration first)
            </option>
            <option value="merge">
              Merge (Keep existing, add new items)
            </option>
          </select>
        ...
        >
          ...
          <div
            v-if="restoreResult.newApiKey"
            class="bg-yellow-900/30 border border-yellow-700 rounded-lg p-3 mt-3"
          >
            <h5 class="font-medium text-yellow-400 text-sm mb-2">
          ...
          <tbody class="divide-y divide-gray-700">
            ...
            >
              ...
              <td class="py-3">
                ...
                <span
                  v-else
                  class="px-2 py-1 bg-yellow-900 text-yellow-300 rounded text-xs"
                >
                  📄 Plaintext
                </span>
              </td>
    ...
    <div class="text-xs text-gray-500 space-y-1 bg-gray-900 rounded-lg p-4">
      ...
      <p class="font-medium text-gray-400 mt-3 mb-2">
