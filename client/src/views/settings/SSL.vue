  ...
  <div class="space-y-6">
    ...
    <div class="bg-blue-900/30 border border-blue-700 rounded-lg p-6">
      ...
      <p class="text-gray-300 mb-4">
        Choose how you want to secure your Classifarr instance:
      </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div :class="['p-4 rounded-lg border-2 transition-colors', !config.enabled ? 'border-blue-500 bg-blue-900/20' : 'border-gray-700 bg-gray-800']">
          ...
          <p class="text-sm text-gray-400 mb-2">
            Use Nginx Proxy Manager, Traefik, Caddy, or similar to handle HTTPS.
          </p>
          ...
          <p class="text-xs text-gray-500 mt-2">
            Leave HTTPS disabled below if using a reverse proxy.
          </p>
        </div>
        ...
        <div :class="['p-4 rounded-lg border-2 transition-colors', config.enabled ? 'border-blue-500 bg-blue-900/20' : 'border-gray-700 bg-gray-800']">
          ...
          <p class="text-sm text-gray-400 mb-2">
            Have Classifarr serve HTTPS directly on port 21325.
          </p>
          <ul class="text-sm text-gray-400 space-y-1">
          ...
          <p class="text-xs text-gray-500 mt-2">
            Enable HTTPS below and provide certificate paths.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-gray-800 rounded-lg p-6">
      ...
      <div class="space-y-4">
        ...
        >
          ...
          <div class="flex items-start">
            ...
            <div class="flex-1">
              ...
              <p class="text-xs text-gray-500 mt-1">
                For high-security environments. Clients must present a valid certificate.
              </p>
            </div>
          </div>
          ...
          <div
            v-if="testResult"
            :class="['p-3 rounded-lg', testResult.success ? 'bg-green-900/30 text-green-400' : 'bg-red-900/30 text-red-400']"
          >
            {{ testResult.message }}
          </div>
        </div>
        ...
        <div
          v-if="saveMessage"
          :class="['p-3 rounded-lg', saveSuccess ? 'bg-green-900/30 text-green-400' : 'bg-red-900/30 text-red-400']"
        >
          {{ saveMessage }}
        </div>
      </div>
    ...
    >
      ...
      <p class="text-sm text-gray-400 mb-3">
        Update your docker-compose.yml to mount certificate files:
      </p>
