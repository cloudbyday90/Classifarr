...
<template>
  <div class="space-y-6">
    ...
    <div
      v-if="loading && !ragData"
      class="flex items-center justify-center py-12"
    >
      <div class="flex flex-col items-center gap-4">
        <div class="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-500" />
        <p class="text-gray-400">
          Loading RAG statistics...
        </p>
      </div>
    </div>
    ...
    <div
      v-else-if="error"
      class="bg-red-900/20 border border-red-700 rounded-lg p-4"
    >
    ...
    <template v-else>
      ...
      <div class="bg-gray-800 border border-gray-700 rounded-lg p-6">
        ...
        >
          ...
          <p
            v-if="embeddingAvailability.retryAt"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
          <div class="bg-gray-700/30 rounded-lg p-4">
            ...
            <p :class="['text-xl font-bold', availabilityToneClasses.textClass]">
              {{ embeddingAvailability.presentation.statusLabel }}
            </p>
          </div>
          ...
          <div class="bg-gray-700/30 rounded-lg p-4">
            ...
            <p class="text-xl font-bold text-white">
              {{ embeddingAvailability.failureCount || 0 }}
            </p>
          </div>
          ...
          <div class="bg-gray-700/30 rounded-lg p-4">
            ...
            <p class="text-sm text-white break-words">
              {{ embeddingAvailability.presentation.detail || 'None' }}
            </p>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <div class="bg-gray-700/30 rounded-lg p-4">
            ...
            <p class="text-xl font-bold text-white">
              {{ circuitBreaker.failureCount }} / {{ circuitBreaker.config?.failureThreshold || 5 }}
            </p>
          </div>
          ...
          <div class="bg-gray-700/30 rounded-lg p-4">
            ...
            <p class="text-sm text-white">
              {{ circuitBreaker.lastFailureTime ? formatTimestamp(circuitBreaker.lastFailureTime) : 'Never' }}
            </p>
          </div>
        </div>
        ...
        <div class="bg-gray-900 rounded-lg p-3 text-sm">
          ...
          <div class="space-y-1">
            <div
              v-if="circuitBreaker.stateHistory?.length === 0"
              class="text-gray-500 py-2"
            >
              No state changes
            </div>
            <div
              v-for="(change, i) in (circuitBreaker.stateHistory || []).slice(-5)"
              :key="i"
              class="text-gray-300 font-mono text-xs"
            >
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          ...
          <div class="bg-gray-700/30 rounded-lg p-4">
            ...
            <p class="text-2xl font-bold text-green-400">
              {{ providerMetrics.successfulRequests || 0 }}
            </p>
          </div>
          ...
          <div class="bg-gray-700/30 rounded-lg p-4">
            ...
            <p class="text-2xl font-bold text-red-400">
              {{ providerMetrics.failedRequests || 0 }}
            </p>
          </div>
          ...
          <div class="bg-gray-700/30 rounded-lg p-4">
            ...
            <p
              ...
              :class="providerMetrics.isModelCold ? 'text-blue-400' : 'text-green-400'"
            >
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-700">
              ...
              <tr
                v-for="(err, i) in (providerMetrics.errorHistory || [])"
                :key="i"
              ...
              >
                ...
                <td class="px-4 py-2 text-white max-w-xs truncate">
                  {{ err.message }}
                </td>
                <td class="px-4 py-2 text-gray-300">
                  {{ err.code || 'N/A' }}
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-700">
              ...
              <tr
                v-for="(retry, i) in (providerMetrics.retryHistory || [])"
                :key="i"
                class="hover:bg-gray-700/30"
              >
                <td class="px-4 py-2 text-gray-300">
                ...
                <td class="px-4 py-2 text-gray-300">
                  {{ retry.backoffDelay }}ms
                </td>
                <td class="px-4 py-2 text-gray-300">
                  {{ retry.retryAfter || 'N/A' }}
                </td>
              </tr>
            </tbody>
          </table>
