...
const POLICY_ROLLBACK_SNAPSHOT_RETENTION_REASON_IDS = Object.freeze({
  EXPIRED_PAYLOADS_REDACTED: 'expired_payloads_redacted',
  NO_EXPIRED_PAYLOADS: 'no_expired_payloads',
