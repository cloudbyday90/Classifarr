...
const policyQuestionContext = require('../utils/policyQuestionContext');
const ragErrorHandler = require('../utils/ragErrorHandler');
const sharedHelpers = require('./classificationPersistenceServiceShared');

const { buildRagLoopSummary } = sharedHelpers;
...
module.exports = classificationPersistenceService;
module.exports.buildRagLoopSummary = buildRagLoopSummary;
module.exports.ClassificationPersistenceService = ClassificationPersistenceService;
module.exports.default = classificationPersistenceService;
