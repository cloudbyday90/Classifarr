...
const { executeArrMediaMove } = require('./shared/arrMediaMove');
const { plexService } = require('./mediaServers');
...
module.exports = reclassificationService;
module.exports.ReclassificationService = ReclassificationService;
module.exports.default = reclassificationService;
