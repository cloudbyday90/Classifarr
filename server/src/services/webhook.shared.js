...
const shared = require('./webhookServiceShared');
...
const {
  ...
  generateSecretKey,
  validateAuth: validateAuthShared,
  sanitizePayload,
  parsePayload,
} = shared;
...
const webhookService = {
  _isEncrypted: isEncrypted,
  _maskConfig: maskConfig,
  _maskConfigs: shared._maskConfigs,
  _encryptSecret: encryptSecret,
  _decryptSecret: decryptSecret,
  generateSecretKey,
  validateAuth,
...
module.exports._isEncrypted = isEncrypted;
module.exports._maskConfig = maskConfig;
module.exports._maskConfigs = shared._maskConfigs;
module.exports._encryptSecret = encryptSecret;
module.exports._decryptSecret = decryptSecret;
...
module.exports.logReceived = logReceived;
module.exports.updateLogStatus = updateLogStatus;
...
module.exports.setPrimaryConfig = setPrimaryConfig;
module.exports.ensureSecretKey = ensureSecretKey;
module.exports.default = webhookService;
