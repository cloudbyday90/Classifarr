...
const DEFAULT_MIGRATION_ARTIFACTS = Object.freeze([
  ...
  },
  {
    ...
    verifierKindId: POLICY_MIGRATION_VERIFIER_KIND_IDS.REPRESENTATIVE_REPLAY,
    replacement: 'Dedicated policy migration verifier route outside normal policy writes',
    normalWorkflowAllowed: false,
    removalGateIds: DEFAULT_REMOVAL_GATES,
    rollbackPlan: DEFAULT_ROLLBACK_PLAN,
  },
  ...
  },
  {
    ...
    decisionId: POLICY_MIGRATION_ARTIFACT_DECISION_IDS.MIGRATION_VERIFIER,
    verifierKindId: POLICY_MIGRATION_VERIFIER_KIND_IDS.REPRESENTATIVE_REPLAY,
    replacement: 'Policy migration replay verifier with explicit retention',
    normalWorkflowAllowed: false,
    removalGateIds: DEFAULT_REMOVAL_GATES,
    rollbackPlan: DEFAULT_ROLLBACK_PLAN,
  },
  ...
  },
  {
    ...
    decisionId: POLICY_MIGRATION_ARTIFACT_DECISION_IDS.MIGRATION_VERIFIER,
    verifierKindId: POLICY_MIGRATION_VERIFIER_KIND_IDS.REPRESENTATIVE_REPLAY,
    replacement: 'Policy evidence engine insufficient-evidence buckets',
    normalWorkflowAllowed: false,
    removalGateIds: DEFAULT_REMOVAL_GATES,
    rollbackPlan: DEFAULT_ROLLBACK_PLAN,
  },
  ...
  },
  {
    ...
    decisionId: POLICY_MIGRATION_ARTIFACT_DECISION_IDS.MIGRATION_VERIFIER,
    verifierKindId: POLICY_MIGRATION_VERIFIER_KIND_IDS.IMPACT_PARITY,
    replacement: 'Policy migration comparison delta report',
    normalWorkflowAllowed: false,
    removalGateIds: DEFAULT_REMOVAL_GATES,
    rollbackPlan: DEFAULT_ROLLBACK_PLAN,
  },
  {
    ...
    decisionId: POLICY_MIGRATION_ARTIFACT_DECISION_IDS.DELETE_AFTER_MIGRATION,
    verifierKindId: POLICY_MIGRATION_VERIFIER_KIND_IDS.REPRESENTATIVE_REPLAY,
    replacement: 'Policy readiness and migration-verifier reason codes',
    normalWorkflowAllowed: false,
    removalGateIds: DEFAULT_REMOVAL_GATES,
    rollbackPlan: DEFAULT_ROLLBACK_PLAN,
  },
