...
const POLICY_STORAGE_CLOSURE_EVIDENCE_ARTIFACTS = Object.freeze([
  ...
  },
  {
    ...
    contractPaths: [
      ...
      'server/src/services/nativeIntentReconciliationStateContract.mjs',
      ...
      'server/src/services/policyInitialIntentEstablishmentContract.mjs',
      'server/src/services/policyInitialIntentEstablishmentPersistence.mjs',
      'server/src/services/policyInitialIntentEstablishmentService.mjs',
      'server/src/services/policyInitialIntentEstablishmentReadinessContract.mjs',
      'server/src/services/policyInitialIntentEstablishmentReadinessPersistence.mjs',
      'server/src/services/policyInitialIntentEstablishmentReadinessService.mjs',
      'server/src/routes/policiesRouteInitialIntentEstablishment.mjs',
      'server/src/routes/policiesRouteInitialIntentEstablishmentReadiness.mjs',
    ...
    testPaths: [
      ...
      'server/src/__tests__/services/nativeIntentReconciliationStateContract.test.mjs',
      ...
      'server/src/__tests__/services/policyInitialIntentEstablishmentContract.test.mjs',
      ...
      'server/src/__tests__/policies-initial-intent-establishment-routes.test.mjs',
      'server/src/__tests__/policies-initial-intent-establishment-readiness-routes.test.mjs',
  ...
  },
  {
    ...
    contractPaths: [
      ...
      'server/src/services/policyObservedEvidenceProvenancePersistence.mjs',
      'server/src/services/policyObservedEvidenceProvenanceRetentionContract.mjs',
      'server/src/services/policyObservedEvidenceProvenanceRetentionPersistence.mjs',
    ...
    testPaths: [
      ...
      'server/src/__tests__/scheduler.test.mjs',
