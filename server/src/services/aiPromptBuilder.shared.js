...
class AIPromptBuilder {
    ...
    get normalizeMetadataList() {
        if (!this._normalizeMetadataList) {
            this._normalizeMetadataList = require('../utils/metadataNormalization').normalizeMetadataList;
        }
...
module.exports.AIPromptBuilder = AIPromptBuilder;
