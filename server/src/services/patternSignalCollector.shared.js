...
class PatternSignalCollector {
    ...
    get embeddingRouter() {
        if (!this._embeddingRouter) {
            this._embeddingRouter = require('./embeddingRouter');
        }
    ...
    get normalizeMetadataList() {
        if (!this._normalizeMetadataList) {
            const mod = require('../utils/metadataNormalization');
            this._normalizeMetadataList = mod.normalizeMetadataList;
        }
    ...
    get normalizeMetadataListLower() {
        if (!this._normalizeMetadataListLower) {
            const mod = require('../utils/metadataNormalization');
            this._normalizeMetadataListLower = mod.normalizeMetadataListLower;
        }
...
module.exports.PatternSignalCollector = PatternSignalCollector;
