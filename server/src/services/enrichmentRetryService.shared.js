 ...
 *
 * Constructor accepts optional dependency injection for testability:
 *   { db, tavilyService, omdbService, logger }
 * When omitted, production defaults are resolved at call time.
 */
...
class EnrichmentRetryService {
    ...
    get tavilyService() {
        if (!this._tavilyService) {
            this._tavilyService = require('./tavily');
        }
    ...
    get omdbService() {
        if (!this._omdbService) {
            this._omdbService = require('./omdb');
        }
...
module.exports.EnrichmentRetryService = EnrichmentRetryService;
module.exports.TAVILY_MONTHLY_DEFERRED_REASON = TAVILY_MONTHLY_DEFERRED_REASON;
module.exports.TAVILY_MONTHLY_DEFERRED_MESSAGE = TAVILY_MONTHLY_DEFERRED_MESSAGE;
module.exports.OMDB_FALLBACK_REASON = OMDB_FALLBACK_REASON;
module.exports.ENRICHMENT_RETRY_STALE_MS = ENRICHMENT_RETRY_STALE_MS;
