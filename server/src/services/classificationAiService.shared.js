 ...
 *   - normalizeAiResponseLine   ΓÇö normalise a raw LLM response to a single clean line
 *   - buildAiRepairPrompt       ΓÇö construct the repair prompt sent to the LLM
 *   - attemptAiResponseRepair   ΓÇö run one repair pass via Ollama
 *   - aiClassify                ΓÇö full AI classification flow (prompt ΓåÆ generate ΓåÆ parse ΓåÆ optional repair)
 */
