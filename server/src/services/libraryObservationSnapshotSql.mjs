...
// Readers define selected_libraries and bounded_ids before these fixed SQL fragments.
export const OBSERVATION_INVENTORY_CTES = `size AS (SELECT COUNT(*)::int AS row_count FROM bounded_ids),
...
export const OBSERVATION_SNAPSHOT_FIELDS = `statement_timestamp()::text AS observed_at,
