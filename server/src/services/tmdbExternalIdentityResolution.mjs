...
import { buildTmdbExternalIdPlan, decideTmdbExternalIdMatch } from './tmdbExternalIdMatch.mjs';

/**
 * Resolve a canonical TMDb identity only when every supplied external ID agrees.
 *
 * The payload format is shared with queue processing, but the decision is not
