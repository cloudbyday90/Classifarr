...
const EXPECTED_INDEX_SQL_NAMES = Object.freeze({
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENTS}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.ACTIVE_INTENT_VERSION}`]:
    'idx_policy_intents_active_version',
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENTS}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.POLICY_LOOKUP}`]:
    'idx_policy_intents_policy_lookup',
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENTS}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.LIBRARY_LOOKUP}`]:
    'idx_policy_intents_library_lookup',
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENTS}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.VALIDATION_STATUS}`]:
    'idx_policy_intents_validation_status',
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENT_RULES}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.RULE_LOOKUP}`]:
    'idx_policy_intent_rules_lookup',
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENT_RULES}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.RULE_VALUES_GIN}`]:
    'idx_policy_intent_rules_values_gin',
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENT_ROUTING_TARGETS}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.ROUTING_TARGET_LOOKUP}`]:
    'idx_policy_intent_routing_targets_lookup',
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENT_TEMPLATE_APPLICATIONS}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.POLICY_LOOKUP}`]:
    'idx_policy_intent_template_applications_lookup',
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENT_MIGRATION_EVENTS}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.MIGRATION_STATE}`]:
    'idx_policy_intent_migration_events_state',
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENT_ROLLBACK_SNAPSHOTS}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.ROLLBACK_EXPIRY}`]:
    'idx_policy_intent_rollback_snapshots_expiry',
  [`${PHASE8R_NATIVE_SCHEMA_TABLE_IDS.POLICY_INTENT_VALIDATION_STATUS}:${PHASE8R_NATIVE_SCHEMA_INDEX_IDS.VALIDATION_STATUS}`]:
...
function buildPolicyBuilderPhase8NativeSqlMigrationCoverage(options = {}) {
  const schemaContract = options.schemaContract || buildPolicyBuilderPhase8NativeSchemaContract();
  const schemaContractValidation = validatePolicyBuilderPhase8NativeSchemaContract(schemaContract);
