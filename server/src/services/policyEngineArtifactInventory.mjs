...
const DEFAULT_POLICY_ENGINE_ARTIFACT_GROUPS = Object.freeze([
  ...
  },
  {
    ...
    artifactPaths: [
      ...
      'client/src/components/policies/PolicyIntentReadinessSummary.vue',
  ...
  {
    id: 'starter_template_draft_contract',
    categoryId: POLICY_ENGINE_ARTIFACT_CATEGORY_IDS.STARTER_TEMPLATE_COMPATIBILITY,
    owner: 'declared-intent-draft',
    decisionId: POLICY_ENGINE_ARTIFACT_DECISION_IDS.KEEP_ENGINE_PRIMITIVE,
    replacement: 'Typed draft commands with secondary starter-template provenance.',
    testDispositionId:
    ...
    artifactPaths: [
      ...
      'docs/architecture/policy-authoring-starter-templates.md',
    ],
  },
  {
    id: 'starter_template_accelerator_ui',
    categoryId: POLICY_ENGINE_ARTIFACT_CATEGORY_IDS.STARTER_TEMPLATE_COMPATIBILITY,
    owner: 'policy-operator-workflow',
    decisionId: POLICY_ENGINE_ARTIFACT_DECISION_IDS.REWRITE_FOR_ENGINE,
    replacement: 'Optional post-destination template accelerator using typed draft commands.',
    testDispositionId:
      POLICY_ENGINE_TEST_DISPOSITION_IDS.REWRITE_ENGINE_CONTRACT,
    normalWorkflowAllowed: false,
    artifactPaths: [
  ...
  {
    id: 'preset_selection_compatibility_ui',
    categoryId: POLICY_ENGINE_ARTIFACT_CATEGORY_IDS.STARTER_TEMPLATE_COMPATIBILITY,
    owner: 'legacy-policy-migration',
    decisionId: POLICY_ENGINE_ARTIFACT_DECISION_IDS.DELETE_AFTER_CUTOVER,
    replacement: 'Native intent migration status and optional draft accelerators.',
    testDispositionId:
      POLICY_ENGINE_TEST_DISPOSITION_IDS.DELETE_WITH_SURFACE,
    normalWorkflowAllowed: false,
    artifactPaths: [
      'client/src/components/policies/PresetSelectionModal.vue',
      'client/src/__tests__/PresetSelectionModal.test.js',
      'client/src/components/policies/PolicyPresetMigrationNotice.vue',
      'client/src/__tests__/PolicyPresetMigrationNotice.test.js',
      'docs/architecture/policy-authoring-starter-template-role-reset.md',
    ],
  },
  {
    id: 'template_name_suggestion_heuristics',
    categoryId: POLICY_ENGINE_ARTIFACT_CATEGORY_IDS.STARTER_TEMPLATE_COMPATIBILITY,
    owner: 'policy-evidence-engine',
    decisionId: POLICY_ENGINE_ARTIFACT_DECISION_IDS.REPLACE_WITH_ENGINE,
    replacement: 'Observed-profile evidence projection with declared-intent confirmation.',
    testDispositionId:
      POLICY_ENGINE_TEST_DISPOSITION_IDS.REPLACE_WITH_ENGINE_CONTRACT,
    normalWorkflowAllowed: false,
    artifactPaths: [
      'server/src/services/policyStarterTemplateSuggestions.mjs',
      'server/src/routes/policiesRoutePresets.mjs',
      ...
      'client/src/api/presetCatalogApi.js',
      'client/src/__tests__/api/presetCatalogApi.test.js',
    ],
  },
  {
