...
const PHASE8R_VALIDATION_COMMANDS = Object.freeze([
  {
    ...
    args: [
      ...
      '--testPathPatterns=policyBuilderPhase8CurrentEvidenceCollector|policyBuilderPhase8CompletionEvidenceRun|policyStorageCompletionCheckpoint|policyStorageCompletionCheckpointArtifact|policyBuilderPhase8CurrentRepositoryClosureAudit|policyBuilderPhase8FinalRequirementCompletionAudit|policyCompatibilityRemovalCompletionAudit|policyCompatibilityRemovalCompletionAuditArtifact|policyBuilderPhase8ValidationEvidence|policyBuilderPhase8ExecutionPlanArtifact|policyBuilderPhase8ControlledRemovalBatchArtifact|policyControlledRemovalApplyArtifact|policyPostRemovalRuntimeVerificationArtifact|policyNextCompatibilityRemovalBatchAuthorizationArtifact|policyBuilderPhase8FinalRemovalAuditEvidence|policyBuilderPhase8FinalClosureReadout|policyBuilderPhase8ImpactMigrationVerifier|policyBuilderPhase8ReplayMigrationVerifier',
      '--no-coverage',
      '--runInBand',
    ],
    cwd: 'server',
  ...
  },
  {
    ...
    args: [
      ...
      'docs/architecture/policy-builder-phase-8r-current-repository-closure-audit.md',
      'docs/architecture/policy-builder-phase-8r-final-requirement-completion-audit.md',
