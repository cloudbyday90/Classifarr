...
/**
 * Shared implementation for the classification_evidence repository.
 *
 * Both the CommonJS and ESM entrypoints instantiate this class so the native
 * runtime path no longer has to proxy the CommonJS singleton directly.
 */
