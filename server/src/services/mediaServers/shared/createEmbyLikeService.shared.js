...
function buildCreateEmbyLikeServiceModule({ axiosClient, normalizeBaseUrl, appendQueryParam, parseProviderIds }) {
...
module.exports = {
  buildCreateEmbyLikeServiceModule,
};
module.exports.buildCreateEmbyLikeServiceModule = buildCreateEmbyLikeServiceModule;
