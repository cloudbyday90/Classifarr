...
const POLICY_AUTHORING_COMPONENT_INVENTORY_ROLE_IDS = Object.freeze({
  ...
  PURPOSE_PROPOSAL_BATCH: 'purpose_proposal_batch',
...
const POLICY_AUTHORING_COMPONENT_INVENTORY = deepFreeze([
  ...
  {
    id: 'policy_purpose_evidence_inventory',
    path: 'client/src/components/policies/PolicyPurposeEvidenceInventory.vue',
    roleId: POLICY_AUTHORING_COMPONENT_INVENTORY_ROLE_IDS.PURPOSE_EVIDENCE_INVENTORY,
    decisionId: POLICY_AUTHORING_COMPONENT_DECISION_IDS.DELETE_FROM_NORMAL_PATH,
    targetComponentIds: [],
    normalAuthoringAllowed: false,
  ...
  },
  {
    ...
    path: 'client/src/components/policies/PolicyPurposeLifecycleProvenanceReceipt.vue',
    roleId: POLICY_AUTHORING_COMPONENT_INVENTORY_ROLE_IDS.PURPOSE_LIFECYCLE_PROVENANCE_RECEIPT,
    decisionId: POLICY_AUTHORING_COMPONENT_DECISION_IDS.DELETE_FROM_NORMAL_PATH,
    targetComponentIds: [],
    normalAuthoringAllowed: false,
    notes: 'Administrator-only read-only lifecycle provenance receipt; it reports bounded aggregate evidence without exposing lifecycle identities or changing policy, semantic selection, or routing.',
  },
  {
  ...
  {
    id: 'policy_purpose_proposal_batch',
    path: 'client/src/components/policies/PolicyPurposeProposalBatch.vue',
    roleId: POLICY_AUTHORING_COMPONENT_INVENTORY_ROLE_IDS.PURPOSE_PROPOSAL_BATCH,
    decisionId: POLICY_AUTHORING_COMPONENT_DECISION_IDS.DELETE_FROM_NORMAL_PATH,
    targetComponentIds: [],
    normalAuthoringAllowed: false,
    notes: 'Administrator-only purpose-maintenance batch card; it renders a redacted server proposal, permits one explicit all-or-nothing apply event, and cannot derive terms, invoke AI/RAG, select semantic evidence, learn, or route media.',
  },
  {
  ...
  {
    id: 'policy_destination_competition_preview',
    path: 'client/src/components/policies/PolicyDestinationCompetitionPreview.vue',
    roleId: POLICY_AUTHORING_COMPONENT_INVENTORY_ROLE_IDS.DESTINATION_COMPETITION_PREVIEW,
    decisionId: POLICY_AUTHORING_COMPONENT_DECISION_IDS.DELETE_FROM_NORMAL_PATH,
    targetComponentIds: [],
    normalAuthoringAllowed: false,
  ...
  {
    id: 'policy_destination_competition_comparison_coverage',
    path: 'client/src/components/policies/PolicyDestinationCompetitionComparisonCoverage.vue',
    roleId: POLICY_AUTHORING_COMPONENT_INVENTORY_ROLE_IDS.DESTINATION_COMPETITION_COVERAGE,
    decisionId: POLICY_AUTHORING_COMPONENT_DECISION_IDS.DELETE_FROM_NORMAL_PATH,
    targetComponentIds: [],
    normalAuthoringAllowed: false,
    notes: 'Administrator-only compatibility-maintenance coverage card; it renders a bounded complete-or-capped aggregate and cannot expose a total, identity, configuration, media record, AI state, or routing authority.',
  },
  {
