...
export const BACKFILL_SCOPE = 'backfill_classification_evidence';
export const DISCOVERED_PATTERN_SCOPES = new Set(['studio', 'franchise', 'genre', 'certification']);

const BATCH_SIZE = 200;

export function transformLearningPatternRow(row, keyBuilder) {
...
export function transformDiscoveredPatternRow(row, keyBuilder) {
...
export async function runBackfill({ db, keyBuilder, dryRun = false }) {
  const summary = {
