...
const sharedHelpers = require('./classificationMetadataServiceShared');
...
module.exports = classificationMetadataService;
module.exports.detectEventTypesFromMetadata = detectEventTypesFromMetadata;
module.exports.enrichWithTMDB = enrichWithTMDB;
module.exports.enrichWithWebSearch = enrichWithWebSearch;
module.exports.getTavilyConfig = getTavilyConfig;
module.exports.mergeMetadataForRecheck = mergeMetadataForRecheck;
module.exports.mightBeAnime = mightBeAnime;
module.exports.parseOverseerrPayload = parseOverseerrPayload;
module.exports.default = classificationMetadataService;
