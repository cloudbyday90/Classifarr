...
import { readLibraryObservationHealthSnapshot } from './libraryObservationHealthQuery.mjs';

/** Retain counts and private fingerprints, without names, traits or provider payloads. */
