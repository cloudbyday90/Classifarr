...
const POLICY_STORAGE_CLOSURE_VALIDATION_EVIDENCE_VERSION =
  'policy.storage_closure_validation_evidence.v3';
...
const POLICY_STORAGE_CLOSURE_VALIDATION_COMMANDS = Object.freeze([
  {
    ...
    args: [
      ...
      '--testPathPatterns=policyActiveIntentIntegrity|policyCandidateAuthorityEligibility|policyIntentMigrationCandidateReport|nativeIntentReconciliationState(Contract|Persistence|Service)|policyInitialIntentEstablishment|policies-initial-intent-establishment|policy-initial-intent-establishment-readiness|policyNativeIntentAuthority|policyNativeIntentReversion|policyRollbackSnapshotRetention|backupRestoreTables[.]nativePolicyIntent|policyStorageClosureCurrentEvidenceCollector|policyStorageClosureEvidenceRun|policyStorageClosureComponentScopeMap|policyStorageCompletionCheckpoint|policyStorageCompletionCheckpointArtifact|generatePolicyStorageCompletionCheckpoint|policyStorageCurrentClosureAudit|policyStorageCurrentClosureAuditIntegrity|runPolicyStorageCurrentClosureAudit|policyStorageClosureRequirementAudit|runPolicyStorageClosureRequirementAudit|policyCompatibilityRemovalCompletionAudit|policyCompatibilityRemovalCompletionAuditArtifact|policyCompatibilityRemovalEvidenceRegeneration|generatePolicyCompatibilityRemovalEvidence|policyStorageClosureReferenceScanner|policyStorageClosureValidationEvidence|policyStorageClosureValidationEvidenceIntegrity|policyStorageClosureValidationEvidenceFingerprint|policyCompatibilityDeletionExecutionPlanArtifact|policyControlledCompatibilityRemovalBatchArtifact|policyControlledRemovalApplyArtifact|policyPostRemovalRuntimeVerificationArtifact|policyPostRemovalRuntimeEvidenceArtifact|policyNextCompatibilityRemovalBatchAuthorization|policyNextCompatibilityRemovalBatchAuthorizationArtifact|policyNextCompatibilityRemovalBatchAuthorizationArtifactIntegrity|policyStorageClosureExecutionPlanSource|policyStorageClosurePathStateCollector|policyStorageClosurePathStateEvidence|policyStorageClosurePathStateEvidenceFingerprint|policyStorageClosurePathStateEvidenceIntegrity|policyStorageClosureFinalRemovalAudit|policyStorageFinalClosureReadout|generatePolicyStorageFinalClosureReadout|migrations',
      '--no-coverage',
      '--runInBand',
    ],
    cwd: 'server',
  ...
  },
  {
    ...
    args: [
      ...
      'docs/architecture/policy-initial-establishment-closure-evidence.md',
