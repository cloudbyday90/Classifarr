...
export async function fitRepresentativeGeometry(items, { signal, maxPasses = REPRESENTATIVE_MAX_PASSES, firstIndex = null, diagnostics = false, retainMemberships = false } = {}) {
  ...
  const session = createRepresentativeFitSession(items, { signal, firstIndex, diagnostics, retainMemberships });
