...
const POLICY_BUILDER_BOUNDARY_RULES = deepFreeze([
  ...
  {
    id: 'policy_destination_competition_preview_orchestration',
    category: POLICY_BUILDER_BOUNDARY_CATEGORIES.UI_ORCHESTRATION,
    ownerId: POLICY_BUILDER_BOUNDARY_OWNER_IDS.CLIENT_ORCHESTRATION,
    actionId: POLICY_BUILDER_BOUNDARY_ACTION_IDS.KEEP_ORCHESTRATION,
    clientEngineAuthorityAllowed: false,
    engineCutlineDecisionRequired: false,
    riskIds: [],
    notes: 'Destination-competition preview orchestration forwards one explicit draft to an administrator-only server endpoint, clears stale aggregate output when the draft changes, and cannot derive a competitor, make a routing decision, or call a provider directly.',
    matches: (filePath) => filePath.endsWith('/usePolicyDestinationCompetitionPreview.js'),
  },
  {
    id: 'policy_destination_competition_preview_presentation',
    category: POLICY_BUILDER_BOUNDARY_CATEGORIES.PRESENTATION_ONLY,
    ownerId: POLICY_BUILDER_BOUNDARY_OWNER_IDS.CLIENT_PRESENTATION,
    actionId: POLICY_BUILDER_BOUNDARY_ACTION_IDS.KEEP_PRESENTATION,
    clientEngineAuthorityAllowed: false,
    ...
    matches: (filePath) => hasAnySegment(filePath, [
      ...
      '/PolicyDestinationCompetitionComparisonCoverage.vue',
  ...
  {
    id: 'policy_save_action_presentation',
    category: POLICY_BUILDER_BOUNDARY_CATEGORIES.PRESENTATION_ONLY,
    ownerId: POLICY_BUILDER_BOUNDARY_OWNER_IDS.CLIENT_PRESENTATION,
    actionId: POLICY_BUILDER_BOUNDARY_ACTION_IDS.KEEP_PRESENTATION,
    clientEngineAuthorityAllowed: false,
    engineCutlineDecisionRequired: false,
    riskIds: [],
    notes: 'Save actions render a direct unmet prerequisite and returned errors, then emit commands. They cannot authorize writes or infer policy, routing, or automation readiness.',
    matches: (filePath) => filePath.endsWith('/PolicyBuilderFooterActions.vue'),
  },
  {
