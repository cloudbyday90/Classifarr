...
function getDefaultScheduler() {
    ...
    // cycle from capturing a half-initialized queueService facade during startup.
...
class QueueCarsaService {
    constructor(deps = {}) {
        ...
        // Dynamic callbacks let queueService keep public delegate methods that tests can spy on.
        ...
        try {
            ...
            (async () => {
                try {
                    ...
                    await this.getScheduler().runGapAnalysis();
...
module.exports = { QueueCarsaService };
