...
/**
 * Shared implementation for the media server pattern analyzer.
 *
 * Both the CommonJS and ESM entrypoints instantiate this class so native route
 * consumers use the same implementation code without proxying the CommonJS
 * singleton directly.
 */
