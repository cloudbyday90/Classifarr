...
const { createArrConfigHandlers, createArrConfigStatusHandler } = require('./helpers/arrConfigHandlers');
const { createAiSettingsHandlers } = require('./helpers/aiSettingsHandlers');
const {
  getDefaultAiSettingsConfig,
  hasTextEmbeddingIdentityChanged,
  resolveEffectiveTextEmbeddingIdentity
} = require('./helpers/aiSettingsHelpers');
const { createDiscordSettingsHandlers } = require('./helpers/discordSettingsHandlers');
const { createSslSettingsHandlers } = require('./helpers/sslSettingsHandlers');
const { createWebhookSettingsHandlers } = require('./helpers/webhookSettingsHandlers');
const {
...
} = require('./helpers/providerConfigHelpers');
const { createMetadataProviderSettingsHandlers } = require('./helpers/metadataProviderSettingsHandlers');
const { createOllamaSettingsHandlers } = require('./helpers/ollamaSettingsHandlers');
const { createPathTestingHandlers } = require('./helpers/pathTestingHandlers');
const { createProviderLockHandlers } = require('./helpers/providerLockHandlers');
const { createSetupHandlers } = require('./helpers/setupHandlers');
const { createGeneralSettingsHandlers } = require('./helpers/generalSettingsHandlers');
const { createConfidenceSettingsHandlers } = require('./helpers/confidenceSettingsHandlers');
...
const arrConfigStatusHandler = createArrConfigStatusHandler({ db });
...
const webhookHandlers = createWebhookSettingsHandlers({
  service: require('../services/webhook'),
  httpClient: axios
});

const sslHandlers = createSslSettingsHandlers({
  db
});
...
const aiHandlers = createAiSettingsHandlers({
  db,
  logger,
  cloudLLMService: require('../services/cloudLLM'),
  aiRouterService: require('../services/aiRouter'),
  ollamaService,
  embeddingProvider,
  embeddingRouter,
  getRagLoopDefaultConfig,
...
const confidenceSettingsHandlers = createConfidenceSettingsHandlers({
  db,
  logger,
  autoLearningService: require('../services/autoLearningService')
});
