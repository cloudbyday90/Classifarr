...
function getDefaultAiSettingsConfig(getRagLoopDefaultConfig, overrides = {}) {
  return {
...
function resolveEffectiveTextEmbeddingIdentity(config = {}) {
...
function hasTextEmbeddingIdentityChanged(previousConfig = {}, nextConfig = {}) {
