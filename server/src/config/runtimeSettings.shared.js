 ...
 */
	...
	const SETTINGS_DEFINITION = {
		...
		// Code-first operational defaults; env remains optional override for advanced use.
	...
	module.exports.getCorsOriginsList = getCorsOriginsList;
	module.exports.getOmdbRuntimeConfig = getOmdbRuntimeConfig;
	module.exports.getEffectiveSettings = getEffectiveSettings;
	module.exports.refreshFromDatabase = refreshFromDatabase;
	module.exports.reloadRuntimeFile = reloadRuntimeFile;
	module.exports.getRuntimeSettingsFilePath = getRuntimeSettingsFilePath;
	module.exports.writeRuntimeSettingsFile = writeRuntimeSettingsFile;
	module.exports.ensureRuntimeSettingsFile = ensureRuntimeSettingsFile;
	module.exports.default = runtimeSettings;
