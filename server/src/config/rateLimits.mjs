...
/** Route-safety aggregate readiness reads (per IP, per 15 minutes). */
export const routeSafetyReadinessLimiterConfig = {
  windowMs: 15 * 60 * 1000,
  max: 30,
  message: { error: 'Too many route-safety readiness requests, please try again later' },
  standardHeaders: true,
  legacyHeaders: false,
};
...
/** AI capability-metrics completed-window trend reads (per IP, per 15 minutes). */
export const aiProviderCapabilityMetricsHealthTrendLimiterConfig = {
  windowMs: 15 * 60 * 1000,
  max: 30,
  message: { error: 'Too many capability-metrics health trend requests, please try again later' },
  standardHeaders: true,
  legacyHeaders: false,
};
...
/** AI capability-metrics completed category-coverage reads (per IP, per 15 minutes). */
export const aiProviderCapabilityMetricsFailureCategoryCoverageLimiterConfig = {
  windowMs: 15 * 60 * 1000,
  max: 30,
  message: { error: 'Too many capability-metrics category-coverage requests, please try again later' },
  standardHeaders: true,
  legacyHeaders: false,
};
...
export const routeSafetyMaintenanceHandoffLimiterConfig = {
  windowMs: 15 * 60 * 1000,
  max: 30,
  message: { error: 'Too many route-safety maintenance handoff requests, please try again later' },
  standardHeaders: true,
  legacyHeaders: false,
};
...
/** Automatic future review-corpus calibration aggregate reads (per IP, per 15 minutes). */
export const policyCandidateCorrectionReviewCorpusCaptureCalibrationReportReadLimiterConfig = {
  windowMs: 15 * 60 * 1000,
  max: 30,
  message: { error: 'Too many review-corpus calibration report requests, please try again later' },
  standardHeaders: true,
  legacyHeaders: false,
  skip: (_req) => process.env.NODE_ENV === 'test',
};
