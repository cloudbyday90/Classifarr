...
export const DB_ADVISORY_LOCKS = {
  ...
  POLICY_NATIVE_INTENT_CHANGE_RECEIPT_RETENTION: 2013,
  POLICY_CANDIDATE_CORRECTION_REVIEW_PROJECTION_RETENTION: 2014,
  POLICY_CANDIDATE_CORRECTION_REVIEW_CORPUS_CAPTURE_RETENTION: 2015,
  HELD_OUT_SEMANTIC_STUDY_LIFECYCLE_REAUDIT: 2016,
  DATABASE_HEALTH_TRANSITION_OBSERVATION: 2017,
