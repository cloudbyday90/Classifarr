...
module.exports.query = timedQuery;
module.exports.pool = pool;
module.exports.healthCheck = healthCheck;
module.exports.withTransaction = withTransaction;
module.exports.tryAdvisoryLock = tryAdvisoryLock;
module.exports.withSessionAdvisoryLock = withSessionAdvisoryLock;
module.exports.DB_ADVISORY_LOCKS = DB_ADVISORY_LOCKS;
module.exports.prewarmHnswIndexes = prewarmHnswIndexes;
module.exports.checkPgStatStatements = checkPgStatStatements;
