...
jest.mock('../services/radarr', () => ({ testConnection: jest.fn() }));
jest.mock('../services/sonarr', () => ({ testConnection: jest.fn() }));
...
describe('healthCheckService - all service checks', () => {
  ...
  beforeEach(() => {
    ...
    radarrService = require('../services/radarr');
    sonarrService = require('../services/sonarr');
    ollamaService = require('../services/ollama');
    tmdbService = require('../services/tmdb');
    omdbService = require('../services/omdb');
    discordBotService = require('../services/discordBot');
    axios = require('axios');
    svc = require('../services/healthCheckService');
  });
