...
jest.mock('../services/classificationPhaseService', () => ({
  getActiveClassifications: jest.fn(),
  getProgress: jest.fn()
}));
...
describe('Classification Progress Routes', () => {
  ...
  describe('GET /classification/progress', () => {
    it('should return active classifications', async () => {
      classificationPhaseService.getActiveClassifications.mockResolvedValueOnce([
    ...
    it('should return 500 on service error', async () => {
      classificationPhaseService.getActiveClassifications.mockRejectedValueOnce(new Error('Service error'));
  ...
  describe('GET /classification/progress/:taskId', () => {
    it('should return progress for specific task', async () => {
      classificationPhaseService.getProgress.mockResolvedValueOnce({
        taskId: 123,
        title: 'Test Movie',
    ...
    it('should return 404 when task not found', async () => {
      classificationPhaseService.getProgress.mockResolvedValueOnce(null);
    ...
    it('should return 500 on service error', async () => {
      classificationPhaseService.getProgress.mockRejectedValueOnce(new Error('Service error'));
