...
jest.mock('../services/ragRetriever', () => ({ semanticSearch: jest.fn(), getSuggestedLibrary: jest.fn() }));
jest.mock('../services/libraryProfileService', () => ({ getProfileScore: jest.fn(), getProfileStats: jest.fn() }));
jest.mock('../services/policyDecisionBuilder', () => ({ normalizeResult: jest.fn(r => r) }));
jest.mock('../services/policyExclusionService', () => ({
...
jest.mock('../services/policyCandidateRanker', () => ({ rankResults: jest.fn(), determineAction: jest.fn() }));
...
// ---------------------------------------------------------------------------
// scoreRelatedEvidence (async, no external deps beyond provided array)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// scoreRAG (async, uses provided ragCache)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// checkAuthoritativeSignals (needs db mock)
// ---------------------------------------------------------------------------
