...
describe('Queue routes coverage', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    queueService.getStats.mockReset();
    queueService.getGapAnalysisStats.mockReset();
    queueService.getLiveStats.mockReset();
    queueService.getEnrichmentRetryStats.mockReset();
    app = express();
