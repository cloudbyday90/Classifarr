...
// Explicit factory ensures searchIMDB is always a jest.fn() regardless of any
// { virtual: true } mock registered by queueService.test.js that would pollute
// the auto-mock shape in a --runInBand test run.
