...
describe('ClassificationEvidenceKeyBuilder', () => {
  ...
  // ── singleton export consistency ─────────────────────────────────────────

  describe('module exports', () => {
    test('singleton export produces same keys as instantiated class', () => {
      const singleton = require('../../services/classificationEvidenceKeyBuilder');
      expect(singleton.buildStudioKey('A24')).toBe(builder.buildStudioKey('A24'));
      expect(singleton.buildGenreKey(['Action', 'Thriller'])).toBe(
