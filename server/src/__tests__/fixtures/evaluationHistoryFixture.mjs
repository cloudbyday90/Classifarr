...
export function evaluationHistoryFixture({ revision = 'one', offset = 0, status = 'proposed', labeled = true, gap } = {}) {
  const version = 'evaluation_history.v2', cohortRevision = adjudicationDigest('cohort'),
