...
![Version](https://img.shields.io/badge/version-v0.45.2--beta-blue.svg)
...
**v0.45.2-beta** is the current public release label in this repo. Package files use the semver-safe form `0.45.2-beta`, while the UI, release notes, and Git tags use `v0.45.2-beta`. This beta line is positioned as stable and production-capable for self-hosted media library operators.
...
services:
  classifarr:
    image: ghcr.io/cloudbyday90/classifarr:v0.45.2-beta
