...
![Version](https://img.shields.io/badge/version-v0.47.5--beta-blue.svg)
...
**v0.47.5-beta** is the current public release label in this repo. Package files use the semver-safe form `0.47.5-beta`, while the UI, release notes, and Git tags use `v0.47.5-beta`. Docker Hub reports **18,000+ pulls** for `cloudbyday90/classifarr` as of 2026-06-14. This beta line is positioned as stable and production-capable for self-hosted media library operators.
