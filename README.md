...
![Version](https://img.shields.io/badge/version-v0.46.1a--beta-blue.svg)
...
**v0.46.1a-beta** is the current public release label in this repo. Package files use the semver-safe form `0.46.1-a.beta`, while the UI, release notes, and Git tags use `v0.46.1a-beta`. Docker Hub reports **15,796 pulls** for `cloudbyday90/classifarr` as of 2026-05-16. This beta line is positioned as stable and production-capable for self-hosted media library operators.
...
services:
  classifarr:
    image: ghcr.io/cloudbyday90/classifarr:v0.46.1a-beta
