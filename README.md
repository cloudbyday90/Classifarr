...
![Version](https://img.shields.io/badge/version-v0.48.0--beta-blue.svg)
...
**v0.48.0-beta** is the current public release label in this repo. Package files use the semver-safe form `0.48.0-beta`, while the UI, release notes, and Git tags use `v0.48.0-beta`. Docker Hub reports **19,000+ pulls** for `cloudbyday90/classifarr` as of 2026-08-09. This beta line is positioned as stable and production-capable for self-hosted media library operators.
